...
// include: C:\Users\stoof\AppData\Local\Temp\tmpgcgfyy3j.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'backend.data';
      var REMOTE_PACKAGE_BASE = 'backend.data';
...
Module['FS_createPath']("/", "OWL-data", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_backend.data');
      }
      Module['addRunDependency']('datafile_backend.data');
    ...
    loadPackage({"files": [{"filename": "/OWL-data/phs_2018_playoffs.csv", "start": 0, "end": 8105903}, {"filename": "/OWL-data/phs_2018_stage_1.csv", "start": 8105903, "end": 40443340}, {"filename": "/OWL-data/phs_2018_stage_2.csv", "start": 40443340, "end": 74551785}, {"filename": "/OWL-data/phs_2018_stage_3.csv", "start": 74551785, "end": 107212430}, {"filename": "/OWL-data/phs_2018_stage_4.csv", "start": 107212430, "end": 143808756}, {"filename": "/OWL-data/phs_2019_playoffs.csv", "start": 143808756, "end": 157751465}, {"filename": "/OWL-data/phs_2019_stage_1.csv", "start": 157751465, "end": 198940775}, {"filename": "/OWL-data/phs_2019_stage_2.csv", "start": 198940775, "end": 245825481}, {"filename": "/OWL-data/phs_2019_stage_3.csv", "start": 245825481, "end": 293794305}, {"filename": "/OWL-data/phs_2019_stage_4.csv", "start": 293794305, "end": 338295108}], "remote_package_size": 338295108});

  })();

// end include: C:\Users\stoof\AppData\Local\Temp\tmpgcgfyy3j.js
// include: C:\Users\stoof\AppData\Local\Temp\tmpj1ylqcr7.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\stoof\AppData\Local\Temp\tmpj1ylqcr7.js
// include: C:\Users\stoof\AppData\Local\Temp\tmpst11283_.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\stoof\AppData\Local\Temp\tmpst11283_.js
